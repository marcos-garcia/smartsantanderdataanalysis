! function t(e, i, n) {
        ...
        function(t, e, i) {
            ! function(t, e) {
                ...
                function h(e, i, o, s) {
                    ...
                    for (var r, l, u, c = "", p = 0, d = e.length; d > p; ++p) switch (r = e[p], l = r[1], r[0]) {
                        case "#":
                            ...
                            break;
                        case "^":
                            u = o.lookup(l), (!u || b(u) && 0 === u.length) && (c += h(r[4], i, o, s));
                            break;
                        case ">":
                ...
                function d(e, n) {
                    ...
                    for (var r, l, h, d, _, L, T = p(n), b = new a(e), P = [], E = [], x = [], w = !1, C = !1; !b.eos();) {
                        if (r = b.pos, h = b.scanUntil(T[0]))
                            for (var M = 0, D = h.length; D > M; ++M) d = h.charAt(M), i(d) ? x.push(E.length) : C = !0, E.push(["text", d, r, r + 1]), r += 1, "\n" == d && s();
                        if (!b.scan(T[0])) break;
                        if (w = !0, l = b.scan(y) || "name", b.scan(m), "=" === l ? (h = b.scanUntil(g), b.scan(g), b.scanUntil(T[1])) : "{" === l ? (h = b.scanUntil(new RegExp("\\s*" + o("}" + n[1]))), b.scan(v), b.scanUntil(T[1]), l = "&") : h = b.scanUntil(T[1]), !b.scan(T[1])) throw new Error("Unclosed tag at " + b.pos);
                        if (_ = [l, h, r, b.pos], E.push(_), "#" === l || "^" === l) P.push(_);
                        else if ("/" === l) {
                    ...
                    if (L = P.pop()) throw new Error('Unclosed section "' + L[1] + '" at ' + b.pos);
                    return u(c(E))
                }
                var m = /\s*/,
                    f = /\s+/,
    ...
    5: [
        function(t, e) {
            ...
            var o = function(t) {
                    ...
                    function b(e, i) {
                        return T(t.LOADERTYPES, e, i)
                    }

                    function P(e, i) {
                        return T(t.URIEFFECTS, e, i)
                    }
                ...
                r = L.FeatureGroup.extend({
                    ...
                    _initialize: function(t) {
                        ...
                        if (n)
                            ...
                            "setStyle" in r && r.setStyle(a.style(t)), r.feature = t, l && r.bindPopup(l, {
                                closeButton: !1
                            }), this.addLayer(r)
                        }
                    }
                ...
                return i.strict(t, "string"), -1 === t.indexOf("/") && (t = n("/geocode/" + t + "/{query}.json", e && e.accessToken)), s.getURL = function() {
                    ...
                    return i.strict(e, "function"), o(s.queryURL(t), function(t, n) {
                        if (n && (n.length || n.features)) {
                            ...
                            n.features && (o.latlng = [n.features[0].center[1], n.features[0].center[0]]), n.features && n.features[0].bbox && (o.bounds = n.features[0].bbox, o.lbounds = i.lbounds(o.bounds)), e(null, o)
                        } else e(t || !0)
                    }), s
        ...
        function(t, e) {
            ...
            var i = t("./geocoder"),
                ...
                o = L.Control.extend({
                    ...
                    initialize: function(t, e) {
                        L.Util.setOptions(this, e), this.setURL(t)
                    },
                    setURL: function(t) {
                    ...
                    _geocode: function(t) {
                        ...
                        var e = this._map,
                            i = L.bind(function(t, e) {
                                if (L.DomUtil.removeClass(this._container, "searching"), !t && e && e.results && e.results.features && e.results.features.length) {
                                    this._results.innerHTML = "";
                                    var i = e.results.features;
                                    if (1 === i.length) this.fire("autoselect", {
                                        feature: i[0]
                                    }), o(i[0]), this._closeIfOpen();
                                    else {
                                        for (var n = 0, s = Math.min(i.length, 5); s > n; n++) {
                                            var a = i[n],
                                                r = a.place_name;
                                            if (r.length) {
                                                var l = L.DomUtil.create("a", "", this._results);
                                                l.innerText = r, l.href = "#", L.bind(function(t) {
                                                    L.DomEvent.addListener(l, "click", function(e) {
                                                        o(t), L.DomEvent.stop(e), this.fire("select", {
                                                            feature: t
                                                        })
                                                    }, this)
                                                }, this)(a)
                                        ...
                                        if (i.length > 5) {
                                            ...
                                            h.innerHTML = "Top 5 of " + i.length + "  results"
                                        }
                                    }
                                    this.fire("found", {
                                        results: e.results
                            ...
                            o = L.bind(function(t) {
                                t.bbox ? this._map.fitBounds(n.lbounds(t.bbox)) : t.center && this._map.setView([t.center[1], t.center[0]], void 0 === e.getZoom() ? this.options.pointZoom : Math.max(e.getZoom(), this.options.pointZoom))
                            }, this);
    ...
    20: [
        function(t, e) {
            "use strict";
            window.L.Icon.Default.imagePath = "//api.tiles.mapbox.com/mapbox.js/v" + t("../package.json").version + "/images";
        ...
        function(t, e) {
            ...
            function i(t, e) {
                ...
                var i = {
                    ...
                    o = t["marker-symbol"] ? "-" + t["marker-symbol"] : "",
    ...
    26: [
        function(t, e) {
            ...
            e.exports = function(t, e) {
                if (e = e || L.mapbox.accessToken, !e && i.REQUIRE_ACCESS_TOKEN) throw new Error("An API access token is required to use Mapbox.js. See https://www.mapbox.com/mapbox.js/api/v" + n + "/l-mapbox-accessToken/");
                ...
                if (o += t, o += -1 !== o.indexOf("?") ? "&access_token=" : "?access_token=", i.REQUIRE_ACCESS_TOKEN) {
                    if ("s" === e[0]) throw new Error("Use a public access token (pk.*) with Mapbox.js, not a secret access token (sk.*). See https://www.mapbox.com/mapbox.js/api/v" + n + "/l-mapbox-accessToken/");
                    o += e
                }
                return o
